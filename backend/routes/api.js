...
// Chat rooms data
const chatRooms = [
    { id: 'exam-stress', name: 'Exam Stress', description: 'A safe space to discuss exam anxiety and study tips', icon: 'BookOpen', color: '#EF4444' },
    { id: 'career-talk', name: 'Career Talk', description: 'Discuss career paths, internships, and future plans', icon: 'Briefcase', color: '#F59E0B' },
    { id: 'positive-vibes', name: 'Positive Vibes', description: 'Share positivity, gratitude, and uplifting moments', icon: 'Sparkles', color: '#10B981' },
    { id: 'focus-zone', name: 'Focus Zone', description: 'Stay focused and accountable with study buddies', icon: 'Target', color: '#3B82F6' },
];
